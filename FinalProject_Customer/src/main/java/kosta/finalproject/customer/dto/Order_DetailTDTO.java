...
public class Order_DetailTDTO {
	...
	private String o_option1; // varchar2(14)
	private int o_option1_num; // number
	private String o_option2; // varchar2(14)
	private int o_option2_num; // number
	private String o_option3; // varchar2(14)
	private int o_option3_num; // number

	private String o_option4; // varchar2(14)
	private int o_option4_num; // number

	private String o_option5; // varchar2(14)
	private int o_option5_num; // number
	...
	public Order_DetailTDTO(int order_detail_num, int order_num, String m_code, String o_pan, String m_necessary1,
			...
			int o_option2_num, String o_option3, int o_option3_num, String o_option4, int o_option4_num,
			String o_option5, int o_option5_num, String o_sauce1, String o_sauce2, String o_vege1, String o_vege2,
			String o_vege3, String o_vege4, String o_vege5, String o_vege6, String o_vege7, String o_vege8,
			int o_price) {
		super();
		this.order_detail_num = order_detail_num;
		this.order_num = order_num;
