          ...
          <div class="nav navbar-nav navbar-right" id="loginmenu" >
			...
			<c:choose>
				<c:when test="${id eq null}">
					<li><a href="loginform.do"> <span class="glyphiconglyphicon-user"> </span>로그인</a></li>
					<li><a href="joinform.do"> <span class="glyphiconglyphicon-user"> </span>회원가입	</a></li>
				</c:when>
				<c:when test="${id ne null }">
					
					<li id="loginid"><span class="glyphicon glyphicon-user"></span> ${id} 님 환영합니다.</li>
						<%--  카드 잔액은 <fmt:formatNumber>${c_coin eq null ? 0 : c_coin}</fmt:formatNumber> 원 입니다 , 아 줄이깨지네--%>
					<li><a href="charge.do"><!-- 카드이미지 있으면 좋겠다 --><span
							class="glyphicon glyphicon-user"></span>카드 : <fmt:formatNumber>${c_coin eq null ? 0 : c_coin}</fmt:formatNumber>원 </a></li>
